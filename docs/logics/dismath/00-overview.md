...
| 11 | [`11-catlazy-formal-methods.md`](./11-catlazy-formal-methods.md) | **Catlazy Formal Methods:** Discrete Mathematics applied to Catlazy engineering, architecture invariants, Hoare planning triples, review resolution, and skill formal foundations. |

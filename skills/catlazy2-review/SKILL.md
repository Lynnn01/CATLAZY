...
- **Observation:** concise evidence and findings across applicable UI, UX, architecture, and lazy-verification rules. For follow-up work, state the next **Observation → Decision → Planned Action → Verification** step.

### 📋 Inspection Checklist

- `[PASS]` / `[FAIL]` / `[N/A]` `[P1-Accessibility]` ...
- `[PASS]` / `[FAIL]` / `[N/A]` `[UX-Feedback]` ...
- `[PASS]` / `[FAIL]` / `[N/A]` `[grep-miss]` ...
- `[PASS]` / `[FAIL]` / `[N/A]` `[api-guess]` ...
- `[PASS]` / `[FAIL]` / `[N/A]` `[style-invent]` ...
- `[PASS]` / `[FAIL]` / `[N/A]` `[hardcode-text]` ...
- `[PASS]` / `[FAIL]` / `[N/A]` `[hollow-implementation]` ...
- `[PASS]` / `[FAIL]` / `[N/A]` `[Architecture]` ...

If any item fails, list details:
- **Target:** `[file:line]`
- **Tag & Rule:** `[tag-name]` (citing violated rule)
- **Evidence:** observed code or behavior failure
- **Smallest Fix:** smallest non-overengineered Catlazy remediation
...
- **Verdict:** For a clean review, include **“The code is simple and follows the project rules.”**
